...
const Calculator = () => {
  ...
  return (
    <div className=" sm:flex sm:flex-row sm:justify-center sm:align-middle gap-10 mt-10 mb-4">
      <div className="flex flex-col bg-transparent sm:w-2/4">
        <h1 className="text-5xl font-bold sm:text-center">Calculate Financing Online!</h1>
        <p className=" text-left mt-2">
          For your comfort, Fancycar.com has designed a car finance calculator
          enabling you to calculate the payment painlessly. You can use our loan
          calculator to ensure that the financing solution you are considering
          suits your budget. Using the calculator is super easy. Just enter the
          loan amount, the down payment, interest rate, and the period and our
          calculator will estimate the payment for you!
        </p>

        <h1 className="text-2xl sm:text-4xl font-bold mt-2 mb-2">
          {" "}
          Tailored Financial Solutions!!!
        </h1>
      </div>
      <form
        className=" rounded-lg shadow-2xl bg-base-200 w-full p-6 sm:w-96 "
        // style={{ width: "400px" }}
      >
