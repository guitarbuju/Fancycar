      ...
      >
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between ">
              ...
              <div className="mt-4 ">
                <span className="block mb-4 text-warning font-semibold ">
                  Contact Us
                </span>
                <h2 className="mb-6 text-2xl font-bold uppercase text-dark  ">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-9 text-body-color sm:p-6 sm:text-lg">
                  Thank you for considering Fancycar.com for your
                  automotive desires. Whether you are an avid collector or a
                  first-time buyer, we are here to assist you on your journey to
                  automotive excellence. Reach out to us today, and let&apos;s make
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    1435 BOSTON POST ROAD - LARCHMONT, NY 10538 
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full px-4 ">
              <div className="relative p-8 bg-white  rounded-lg shadow-lg sm:p-12">
                <form onSubmit={handleSubmit(onSubmit)}>
                  <input
                   className="border-[f0f0f0] w-full rounded-lg border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none mb-4"
                    type="text"
                    name="name"
                  ...
                  />
                  <input
                   className="border-[f0f0f0] w-full rounded-lg border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none mb-8"
                    type="text"
                    name="phone"
                  ...
                  />
                   <textarea
                    className="border-[f0f0f0]  mb-8 textarea textarea-bordered textarea-lg w-full max-w-xs text-gray-400"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white transition border rounded  bg-warning  hover:bg-opacity-90 mb-2"
                    >
                      Send Message
                    </button>
                    <button
                      type="reset"
                      className="w-full p-3 text-white transition border rounded  btn-ghost btn hover:bg-opacity-90"
                    >
                      Reset
                    </button>
                  </div>
